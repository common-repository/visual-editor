...
/***/ "./src/attributes/toolbarButtonDelete.js":
/*!*****************************************!*\
...
const {
  __
} = wp.i18n; // Enable custom attributes on block
...
wp.hooks.addFilter('blocks.registerBlockType', 'custom-attributes/set-toolbar-button-attribute-delete', setToolbarButtonAttribute);
/**
...
const withToolbarButton = createHigherOrderComponent(BlockEdit => {
  return props => {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(BlockControls, {
      ...
      icon: "trash",
      label: __('Delete Block', 'visual-editor-blocks'),
...
wp.hooks.addFilter('editor.BlockEdit', 'custom-attributes/with-toolbar-button-delete', withToolbarButton);
/**
...
wp.hooks.addFilter('editor.BlockListBlock', 'custom-attributes/with-toolbar-button-prop-delete', withToolbarButtonProp);
/**
...
wp.hooks.addFilter('blocks.getSaveContent.extraProps', 'visual-editor-toolbar/delete-button', saveToolbarButtonAttribute);
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _attributes_toolbarButton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./attributes/toolbarButton */ "./src/attributes/toolbarButtonDelete.js");
